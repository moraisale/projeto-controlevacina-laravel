...
class UnidadeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('mensagem', 'Unidade cadastrada!');
    ...
    public function update(Request $request, Unidade $unidade)
    {
        ...
        return redirect()->route('unidades.index')->with('alert', 'Unidade atualizada!');
    }
    ...
    {
        $unidade->delete();
        return redirect()->route('unidades.index')->with('alert', 'Unidade excluída!');
    }
}
